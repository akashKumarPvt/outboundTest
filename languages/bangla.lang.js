...
export async function getBenDtmf(dtmf, person1) {
  if (dtmf === "2") {
    await setDtmfUser("dtmf2", person1);
    await setUserChoice("bengali", person1);
    ...
    return getBenDtmf("2", person1)
  }
}

export async function getBenDtmf2(dtmf, person1) {
  if (dtmf == "1") {
    ...
    await setDtmfUser("dtmf2", person1)
    return getBenDtmf2("1", person1)
  }
}

export async function getBenDtmf3(dtmf, person1) {
  if (dtmf === "1") {
    ...
    await setDtmfUser("dtmf3", person1)
    return getBenDtmf2("1" || "0", person1)
  }
}

export async function getBenDtmf4Sec1(dtmf, person1) {
  if (dtmf === "1" || dtmf === "2" || dtmf === "3") {
    ...
    await setDtmfUser("dtmf41", person1)
    return getBenDtmf3("1", person1)
  }
}

export async function getBenDtmf4Sec2(dtmf, person1) {
  if (dtmf === "1" || dtmf === "2" || dtmf === "3" || dtmf === "4") {
    ...
    await setDtmfUser("dtmf42", person1)
    return getBenDtmf3("2", person1)
  }
}

export async function getBenDtmf5(dtmf, person1) {
  if (dtmf === "1") {
...
export async function getBenDtmf5Sec1(dtmf, person1) {
  if (dtmf >= "1" && dtmf <= "7") {
    ...
    await setDtmfUser("dtmf51", person1)
    return getBenDtmf5("1", person1)
  }
}

export async function getBenDtmf5Sec2(dtmf, person1) {
  if (dtmf === "1") {
    await setDtmfUser("dtmf5", person1)
    ...
    await setDtmfUser("dtmf52", person1)
    return getBenDtmf5("2", person1)
  }
}

export async function getBenDtmf5Sec3(dtmf, person1) {
  if (dtmf === "1") {
    await setDtmfUser("dtmf5", person1)
...
export async function getBenDtmf6(dtmf, person1) {
...
export async function getBenDtmfLast(dtmf, person1) {
