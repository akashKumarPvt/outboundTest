...
export async function getTelDtmf(dtmf, person1) {
  if (dtmf === "4") {
    await setDtmfUser("dtmf2", person1);
    await setUserChoice("telugu", person1);
...
export async function getTelDtmf2(dtmf, person1) {
  if (dtmf == "1") {
    ...
    await setDtmfUser("dtmf2", person1)
    return getTelDtmf2("1", person1)
  }
}

export async function getTelDtmf3(dtmf, person1) {
  if (dtmf === "1") {
...
export async function getTelDtmf4Sec1(dtmf, person1) {
  if (dtmf === "1" || dtmf === "2" || dtmf === "3") {
    ...
    await setDtmfUser("dtmf41", person1)
    return getTelDtmf3("1", person1)
  }
}

export async function getTelDtmf4Sec2(dtmf, person1) {
  if (dtmf === "1" || dtmf === "2" || dtmf === "3" || dtmf === "4") {
    ...
    await setDtmfUser("dtmf42", person1)
    return getTelDtmf3("2", person1)
  }
}

export async function getTelDtmf5(dtmf, person1) {
  if (dtmf === "1") {
...
export async function getTelDtmf5Sec1(dtmf, person1) {
  if (dtmf >= "1" && dtmf <= "7") {
    ...
    await setDtmfUser("dtmf51", person1)
    return getTelDtmf5("1", person1)
  }
}

export async function getTelDtmf5Sec2(dtmf, person1) {
  if (dtmf === "1") {
    await setDtmfUser("dtmf5", person1)
    ...
    await setDtmfUser("dtmf52", person1)
    return getTelDtmf5("2", person1)
  }
}

export async function getTelDtmf5Sec3(dtmf, person1) {
  if (dtmf === "1") {
...
export async function getTelDtmf6(dtmf, person1) {
...
export async function getTelDtmfLast(dtmf, person1) {
