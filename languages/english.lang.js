...
//     await setUserChoice("english", getPerson);
...
export async function getEngDtmf(dtmf, getPerson) {
  if (dtmf === "0") {
...
export async function getEngDtmf2(dtmf, getPerson) {
  if (dtmf == "1") {
...
export async function getEngDtmf3(dtmf, getPerson) {
  if (dtmf === "1") {
...
export async function getEngDtmf4Sec1(dtmf, getPerson) {
...
export async function getEngDtmf4Sec2(dtmf, getPerson) {
...
export async function getEngDtmf5(dtmf, getPerson) {
  if (dtmf === "1") {
...
export async function getEngDtmf5Sec1(dtmf, getPerson) {
  if (dtmf >= "1" && dtmf <= "7") {
    ...
    await setDtmfUser("dtmf51", getPerson)
    return getEngDtmf5("1", getPerson)
  }
}

export async function getEngDtmf5Sec2(dtmf, getPerson) {
  if (dtmf === "1") {
    await setDtmfUser("dtmf5", getPerson)
    ...
    await setDtmfUser("dtmf52", getPerson)
    return getEngDtmf5("2", getPerson)
  }
}

export async function getEngDtmf5Sec3(dtmf, getPerson) {
  if (dtmf === "1") {
    await setDtmfUser("dtmf5", getPerson)
...
// export async function getEngDtmf6(dtmf, getPerson) {
...
// export async function getEngDtmfLast(dtmf, getPerson) {
//   if (dtmf.length <= 6 && parseInt(dtmf) >= 6 && parseInt(dtmf) <= 999999) {
//     await setDtmfUser("dtmf7", getPerson);
//     await setUserChoice("Entered OTP", getPerson)
//     return [
//       {
//         action: "play",
